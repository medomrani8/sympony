 ...
 */
class Club extends \App\Entity\Club implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Club' . "\0" . 'idclub', '' . "\0" . 'App\\Entity\\Club' . "\0" . 'categorie', '' . "\0" . 'App\\Entity\\Club' . "\0" . 'validite', '' . "\0" . 'App\\Entity\\Club' . "\0" . 'numtel', '' . "\0" . 'App\\Entity\\Club' . "\0" . 'adresse'];
        }
