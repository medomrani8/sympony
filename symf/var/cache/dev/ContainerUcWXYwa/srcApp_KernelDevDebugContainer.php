...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('DFjudlDQ-M', 0, ($this->targetDir.''.'/pools'), new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('Cqt-jvMwRg', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('SOIeFtFm3f', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('D+0FlRzPl5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('rIzHfIUqT-', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('50QHt75OXI', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3jbRPjPsa8', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
...
class EntityManager_9a5be93 extends \Doctrine\ORM\EntityManager implements \ProxyManager\Proxy\VirtualProxyInterface
{
     ...
     */
    private $valueHolder8c887 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer56317 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicPropertiesf0fcb = [
        
    ];

    public function getConnection()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getConnection', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getConnection();
    }

    public function getMetadataFactory()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getMetadataFactory', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getMetadataFactory();
    }

    public function getExpressionBuilder()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getExpressionBuilder', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getExpressionBuilder();
    }

    public function beginTransaction()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'beginTransaction', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->beginTransaction();
    }

    public function getCache()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getCache', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getCache();
    }

    public function transactional($func)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'transactional', array('func' => $func), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->transactional($func);
    }

    public function wrapInTransaction(callable $func)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'wrapInTransaction', array('func' => $func), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->wrapInTransaction($func);
    }

    public function commit()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'commit', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->commit();
    }

    public function rollback()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'rollback', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->rollback();
    }

    public function getClassMetadata($className)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getClassMetadata', array('className' => $className), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getClassMetadata($className);
    }

    public function createQuery($dql = '')
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'createQuery', array('dql' => $dql), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->createQuery($dql);
    }

    public function createNamedQuery($name)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'createNamedQuery', array('name' => $name), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->createNamedQuery($name);
    }

    public function createNativeQuery($sql, \Doctrine\ORM\Query\ResultSetMapping $rsm)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'createNativeQuery', array('sql' => $sql, 'rsm' => $rsm), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->createNativeQuery($sql, $rsm);
    }

    public function createNamedNativeQuery($name)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'createNamedNativeQuery', array('name' => $name), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->createNamedNativeQuery($name);
    }

    public function createQueryBuilder()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'createQueryBuilder', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->createQueryBuilder();
    }

    public function flush($entity = null)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'flush', array('entity' => $entity), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->flush($entity);
    }

    public function find($className, $id, $lockMode = null, $lockVersion = null)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'find', array('className' => $className, 'id' => $id, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->find($className, $id, $lockMode, $lockVersion);
    }

    public function getReference($entityName, $id)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getReference', array('entityName' => $entityName, 'id' => $id), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getReference($entityName, $id);
    }

    public function getPartialReference($entityName, $identifier)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getPartialReference', array('entityName' => $entityName, 'identifier' => $identifier), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getPartialReference($entityName, $identifier);
    }

    public function clear($entityName = null)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'clear', array('entityName' => $entityName), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->clear($entityName);
    }

    public function close()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'close', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->close();
    }

    public function persist($entity)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'persist', array('entity' => $entity), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->persist($entity);
    }

    public function remove($entity)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'remove', array('entity' => $entity), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->remove($entity);
    }

    public function refresh($entity)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'refresh', array('entity' => $entity), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->refresh($entity);
    }

    public function detach($entity)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'detach', array('entity' => $entity), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->detach($entity);
    }

    public function merge($entity)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'merge', array('entity' => $entity), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->merge($entity);
    }

    public function copy($entity, $deep = false)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'copy', array('entity' => $entity, 'deep' => $deep), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->copy($entity, $deep);
    }

    public function lock($entity, $lockMode, $lockVersion = null)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'lock', array('entity' => $entity, 'lockMode' => $lockMode, 'lockVersion' => $lockVersion), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->lock($entity, $lockMode, $lockVersion);
    }

    public function getRepository($entityName)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getRepository', array('entityName' => $entityName), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getRepository($entityName);
    }

    public function contains($entity)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'contains', array('entity' => $entity), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->contains($entity);
    }

    public function getEventManager()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getEventManager', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getEventManager();
    }

    public function getConfiguration()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getConfiguration', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getConfiguration();
    }

    public function isOpen()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'isOpen', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->isOpen();
    }

    public function getUnitOfWork()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getUnitOfWork', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getUnitOfWork();
    }

    public function getHydrator($hydrationMode)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getHydrator', array('hydrationMode' => $hydrationMode), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getHydrator($hydrationMode);
    }

    public function newHydrator($hydrationMode)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'newHydrator', array('hydrationMode' => $hydrationMode), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->newHydrator($hydrationMode);
    }

    public function getProxyFactory()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getProxyFactory', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getProxyFactory();
    }

    public function initializeObject($obj)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'initializeObject', array('obj' => $obj), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->initializeObject($obj);
    }

    public function getFilters()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'getFilters', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->getFilters();
    }

    public function isFiltersStateClean()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'isFiltersStateClean', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->isFiltersStateClean();
    }

    public function hasFilters()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'hasFilters', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return $this->valueHolder8c887->hasFilters();
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer56317 = $initializer;
    ...
    protected function __construct(\Doctrine\DBAL\Connection $conn, \Doctrine\ORM\Configuration $config, \Doctrine\Common\EventManager $eventManager)
    {
        ...
        if (! $this->valueHolder8c887) {
            $reflection = $reflection ?? new \ReflectionClass('Doctrine\\ORM\\EntityManager');
            $this->valueHolder8c887 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\Doctrine\ORM\EntityManager $instance) {
            unset($instance->config, $instance->conn, $instance->metadataFactory, $instance->unitOfWork, $instance->eventManager, $instance->proxyFactory, $instance->repositoryFactory, $instance->expressionBuilder, $instance->closed, $instance->filterCollection, $instance->cache);
        ...
        $this->valueHolder8c887->__construct($conn, $config, $eventManager);
    }

    public function & __get($name)
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, '__get', ['name' => $name], $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        if (isset(self::$publicPropertiesf0fcb[$name])) {
            return $this->valueHolder8c887->$name;
        }

        $realInstanceReflection = new \ReflectionClass('Doctrine\\ORM\\EntityManager');

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder8c887;
    ...
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;
    ...
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, '__isset', array('name' => $name), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;
    ...
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, '__unset', array('name' => $name), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;
    ...
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, '__clone', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        $this->valueHolder8c887 = clone $this->valueHolder8c887;
    }

    public function __sleep()
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, '__sleep', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        return array('valueHolder8c887');
    }
    ...
    {
        $this->initializer56317 = $initializer;
    }

    public function getProxyInitializer() : ?\Closure
    {
        return $this->initializer56317;
    }

    public function initializeProxy() : bool
    {
        return $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'initializeProxy', array(), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;
    }

    public function isProxyInitialized() : bool
    {
        return null !== $this->valueHolder8c887;
    }

    public function getWrappedValueHolderValue()
    {
        return $this->valueHolder8c887;
    }
...
class PaginatorInterface_82dac15 implements \ProxyManager\Proxy\VirtualProxyInterface, \Knp\Component\Pager\PaginatorInterface
{
    ...
    {
        $this->initializer56317 && ($this->initializer56317->__invoke($valueHolder8c887, $this, 'paginate', array('target' => $target, 'page' => $page, 'limit' => $limit, 'options' => $options), $this->initializer56317) || 1) && $this->valueHolder8c887 = $valueHolder8c887;

        if ($this->valueHolder8c887 === $returnValue = $this->valueHolder8c887->paginate($target, $page, $limit, $options)) {
            return $this;
        }
